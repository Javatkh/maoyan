<template>
  <div class="bottom-nav-bar" v-if="$store.getters.getIsShowTabbar">
    <div @click="dealClick(0)" :class="{current:tabIndex==0}" class="nav-icon-wrapper " data-tab=".movie">
    ...
    <div @click="dealClick(1)" :class="{current:tabIndex==1}" class="nav-icon-wrapper" data-tab=".cinema">
    ...
    <div @click="dealClick(2)" :class="{current:tabIndex==2}" class="nav-icon-wrapper" data-tab=".my">
  ...
  data () {
	...
	computed:{
		tabIndex(){
            ...
            cosnole.log(this.$store.getters.getTabIndex)
		}
	},
	watch:{
